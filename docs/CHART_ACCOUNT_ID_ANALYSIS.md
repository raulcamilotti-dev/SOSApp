...
| POS Sale         | _(nenhum)_                   | `1.1.01` ou `1.1.02`         |
| Marketplace      | _(nenhum)_                   | `1.1.01` ou `1.1.02`         |
| Contract Billing | _(nenhum)_                   | `1.1.01` Receita de Serviços |
...
_Documento gerado em análise automatizada do codebase — Fevereiro 2026_
