  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      ...
      <ThemedView style={styles.content}>
        ...
        <ThemedText style={styles.sectionText}>
          Sem esse processo, o imóvel fica &quot;irregular&quot;, o que impede a venda,
          dificulta o financiamento, bloqueia a transferência para herdeiros e
          até pode gerar multas ou problemas judiciais.
        </ThemedText>
