    ...
    <ScrollView contentContainerStyle={{ padding: 16 }}>
      <ThemedView style={styles.processCard}>
        ...
        <ThemedText style={[styles.processSubtitle, { color: mutedTextColor }]}>
          Cria automaticamente todas as permissões definidas no código que ainda
        ...
        >
          <ThemedText
            style={{ color: onTintTextColor, fontWeight: "600", fontSize: 15 }}
          >
        ...
        >
          ...
          >
            ⚡ Execute esta sincronização sempre que adicionar novas permissões
            no código ou após uma atualização do sistema.
          </ThemedText>
        </ThemedView>
      </ThemedView>
    </ScrollView>
