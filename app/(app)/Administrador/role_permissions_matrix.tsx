  ...
  const loadData = useCallback(async () => {
    try {
      ...
      const [rolesRes, permissionsRes, rolePermissionsRes, tenantsRes] =
        await Promise.all([
          api.post(ENDPOINT, { action: "list", table: "roles" }),
          api.post(ENDPOINT, { action: "list", table: "permissions" }),
          api.post(ENDPOINT, { action: "list", table: "role_permissions" }),
          api.post(ENDPOINT, { action: "list", table: "tenants" }),
        ]);
